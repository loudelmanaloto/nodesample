<?php  
	...
	class GlobalMethods {
		...
		public function _common($sql) {

			$res = $this->execute_query($sql, "No records found");
			...
			return $this->api_result($payload, $remarks, $message, $res['code']);
		...
		public function api_result($payload, $remarks, $message, $code) {
			...
			return array(
				...
				"prepared_by"=>array("dev"=>"Gordon College Developers, Gordon College-CCS"), 
